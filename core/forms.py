...
#### Formularios del carrito de compras ######

class CarritoDeComprasForm(forms.Form):
    nombre_usuario = forms.CharField(label='Nombre de usuario')
    productos_seleccionados = forms.MultipleChoiceField(label='Productos seleccionados', widget=forms.CheckboxSelectMultiple)
